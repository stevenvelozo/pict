...
declare class PictRecordSetFilterManager extends libPictProvider {
     ...
     * @param {(pError?: Error) => void} fCallback
     */
    loadRecordPageByFilterUsingProvider(pEntityProvider: import("../Pict-Meadow-EntityProvider.js"), pFilterConfiguration: Array<Record<string, any>>, pFilterExperience: Record<string, any>, pRecordOffset: number | string | ((pError?: Error) => void), pPageSize: number | string | ((pError?: Error) => void), fCallback: (pError?: Error) => void): void;
    /**
     ...
     * @param {(pError?: Error) => void} fCallback
     */
    executeFilterPageUsingProvider(pEntityProvider: import("../Pict-Meadow-EntityProvider.js"), pFilterConfigurationAddress: string, pFilterExperienceAddress: string, pRecordOffset: number | ((pError?: Error) => void), pPageSize: number | ((pError?: Error) => void), fCallback: (pError?: Error) => void): void;
    /**
     * @param {string} pFilterConfigurationAddress
     * @param {string} pFilterExperienceAddress
     * @param {(pError?: Error) => void} fCallback
