...
* @author <steven@velozo.com>
*/
var r=e("./Pict.js");"object"===("undefined"==typeof window?"undefined":_typeof(window))&&(window.Pict=r),t.exports=r},{"./Pict.js":104}],101:[function(e,t,n){var r=e("fable").ServiceProviderBase,i=e("elucidator"),o=function(e){_inherits(n,e);var t=_createSuper(n);function n(e,r,o){var a;return _classCallCheck(this,n),(a=t.call(this,e,r,o)).serviceType="Solver",a.solver=new i(a.options),a}return _createClass(n)}(r);t.exports=o},{elucidator:31,fable:79}],102:[function(e,t,n){var r=e("fable").ServiceProviderBase,i=e("informary"),o=function(e){_inherits(n,e);var t=_createSuper(n);function n(e,r,o){var a;return _classCallCheck(this,n),(a=t.call(this,e,r,o)).serviceType="Informary",a.informary=new i(a.options.Settings,a.options.Context,a.options.ContextGUID),a}return _createClass(n)}(r);t.exports=o},{fable:79,informary:81}],103:[function(e,t,n){var r=e("fable").ServiceProviderBase,i=e("manyfest"),o=function(e){_inherits(n,e);var t=_createSuper(n);function n(e,r,o){var a;return _classCallCheck(this,n),(a=t.call(this,e,r,o)).serviceType="Manifest",a.manyfest=!1,"{}"!=JSON.stringify(a.options)?a.manyfest=new i(a.options):a.manyfest=new i,a.manifest=a.manyfest,a}return _createClass(n)}(r);t.exports=o},{fable:79,manyfest:92}],104:[function(e,t,n){
/**
* Pict browser shim loader
* @license MIT
* @author <steven@velozo.com>
*/
var r=e("fable"),i=e("./Pict-Fable-Service-Manyfest.js"),o=e("./Pict-Fable-Service-Elucidator.js"),a=e("./Pict-Fable-Service-Informary.js"),s=(e("mousetrap"),function(){function e(t){_classCallCheck(this,e),this.fable=new r(t),this.log=this.fable.log,this.settings=this.fable.settings,this.serviceManager=this.fable.serviceManager,this.fable.serviceManager.addServiceType("Manifest",i),this.fable.serviceManager.addServiceType("Solver",o),this.fable.serviceManager.addServiceType("Informary",a),this.defaultTemplateProcessor=this.fable.serviceManager.instantiateServiceProvider("MetaTemplate",{},"defaultTemplateProcessor"),this._DefaultTemplateMethodsInitialized=!1,this.manifestServiceProvider=this.fable.serviceManager.instantiateServiceProvider("Manifest",{},"defaultManifest"),this.manifest=this.manifestServiceProvider.manifest,this._TemplateContainer={},this.appData={}}return _createClass(e,[{key:"initializeTemplateMethods",value:function(e){var t=this;this._DefaultTemplateMethodsInitialized||(this.defaultTemplateProcessor.addPattern("{~Data:","~}",(function(e,n){var r=e.trim(),i=t.manifest.getValueAtAddress({AppData:t.appData,Record:n},r);return null==i||"undefined"==i||void 0===i?(console.log("undefined!"),""):i})),this.defaultTemplateProcessor.addPattern("{~Dollars:","~}",(function(e,n){var r=e.trim(),i=t.manifest.getValueAtAddress({AppData:t.appData,Record:n},r);return t.fable.DataArithmatic.formatterDollars(i)})),this.defaultTemplateProcessor.addPattern("{~Digits:","~}",(function(e,n){var r=e.trim(),i=t.manifest.getValueAtAddress({AppData:t.appData,Record:n},r);return t.fable.DataArithmatic.formatterAddCommasToNumber(t.fable.DataArithmatic.formatterRoundNumber(i,2))})),this.defaultTemplateProcessor.addPattern("{~NotEmpty:","~}",(function(e,n){var r=e.trim().split("|");return 2!=r.length?"":t.manifest.getValueAtAddress({AppData:t.appData,Record:n},r[0])?r[1]:""})),this._DefaultTemplateMethodsInitialized=!0)}},{key:"parseTemplate",value:function(e,t){return this.defaultTemplateProcessor.parseString(e,t)}}]),e}());t.exports=s},{"./Pict-Fable-Service-Elucidator.js":101,"./Pict-Fable-Service-Informary.js":102,"./Pict-Fable-Service-Manyfest.js":103,fable:79,mousetrap:93}]},{},[100])(100)}));
